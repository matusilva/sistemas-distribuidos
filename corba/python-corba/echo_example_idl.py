# Python stubs generated by omniidl from echo_example.idl
...
#
__name__ = "Example"
_0_Example = omniORB.openModule("Example", r"echo_example.idl")
_0_Example__POA = omniORB.openModule("Example__POA", r"echo_example.idl")
